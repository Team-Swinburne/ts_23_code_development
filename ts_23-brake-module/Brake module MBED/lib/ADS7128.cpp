...
//DigitalIn MISO_PIN(PB_4);
//DigitalOut MOSI_PIN(PB_5);
//DigitalOut SCLK_PIN(PB_3); 
//DigitalOut CS_PIN(PB_6);


//spi = SPI(MISO_PIN, MOSI_PIN, SCLK_PIN, CS_PIN);
...
//void spiSendReceive(const char tx_buffer, u8int tx_length, const char rx_buffer, u8int rx_length) {
//    Data = spi.write(tx_buffer, tx_length, rx_buffer, rx_length)
//}
