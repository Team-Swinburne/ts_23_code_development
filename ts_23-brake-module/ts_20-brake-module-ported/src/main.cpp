/*  TEAM SWINBURNE - TS23 
    BRAKE MODULE - HARDWARE REVISION 6
    ETHAN JONES, MICHAEL COCHRANE, THOMAS BENNETT, LUKE D'ELTON
    ...
    3.0        29/11/2023     Added spi communication to the brake pressure sensor
*/
...
int main() 
{
  // Disable interrupts for smooth startup routine.
	wait_us(1000*1000); // Wait 1 second for the CAN transceiver to start up.
